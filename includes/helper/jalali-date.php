...
class Jalali_Date {
	...
	function jdate( $format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa' ) {
		...
		[ $j_y, $j_m, $j_d ] = $this->gregorian_to_jalali( $date[8], $date[3], $date[2] );
	...
	function jstrftime( $format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa' ) {
		...
		[ $j_y, $j_m, $j_d ] = $this->gregorian_to_jalali( $date[7], $date[4], $date[3] );
		$doy = ( $j_m < 7 ) ? ( ( $j_m - 1 ) * 31 ) + $j_d - 1 : ( ( $j_m - 7 ) * 30 ) + $j_d + 185;
		$kab = ( $j_y % 33 % 4 - 1 == (int) ( $j_y % 33 * .05 ) ) ? 1 : 0;
		$sl  = strlen( $format );
		$out = '';
	...
	function jmktime( $h = '', $m = '', $s = '', $jm = '', $jd = '', $jy = '', $is_dst = - 1 ) {
		...
		if ( $h == '' and $m == '' and $s == '' and $jm == '' and $jd == '' and $jy == '' ) {
			...
			[ $year, $month, $day ] = $this->jalali_to_gregorian( $jy, $jm, $jd );
